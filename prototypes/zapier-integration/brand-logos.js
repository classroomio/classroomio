...
window.ZI_BRAND_LOGOS = {
  ...
  zoom: {
    name: 'Zoom',
    svg: '<svg viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#0B5CFF"/><rect x="6" y="10.5" width="13" height="11" rx="2.6" fill="#fff"/><path d="M21 14.2 26.2 10.6v10.8L21 17.8z" fill="#fff"/></svg>'
  },
  calendly: {
    name: 'Calendly',
    svg: '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="15" fill="#006BFF"/><path d="M20.4 11.6a6 6 0 1 0 0 8.8" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round"/></svg>'
  },
  customerio: {
    name: 'Customer.io',
    svg: '<svg viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#5B3DF5"/><circle cx="16" cy="16" r="7" fill="none" stroke="#fff" stroke-width="3"/><circle cx="16" cy="16" r="2.2" fill="#fff"/></svg>'
  },
  classroomio: {
    name: 'ClassroomIO',
    svg: '<svg viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#1D4ED8"/><path d="M16 7 4.5 13 16 19l9-4.7V21h2.5v-8z" fill="#fff"/><path d="M9 17.4v4.3c0 1.6 3.1 3.3 7 3.3s7-1.7 7-3.3v-4.3L16 21z" fill="#fff" opacity=".9"/></svg>'
  }
};
