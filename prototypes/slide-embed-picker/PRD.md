...
6. **"How to embed" docs button.** Every platform has a deep link to `classroomio.com/help/create-and-deliver/embed-slides#<platform>` for step-by-step help.
...
- **Docs.** Add `apps/help/content/help/create-and-deliver/embed-slides.mdx` with a section per platform and stable `#<platform>` anchors matching the `docs` links.
