...
CREATE OR REPLACE FUNCTION "public"."get_courses"("org_id_arg" "uuid", "profile_id_arg" "uuid") RETURNS TABLE("id" "uuid", "org_id" "uuid", "title" character varying, "slug" character varying, "description" character varying, "logo" "text", "banner_image" "text", "cost" bigint, "currency" character varying, "is_published" boolean, "profile_id" "uuid", "role_id" bigint, "total_lessons" bigint, "total_students" bigint, "progress_rate" bigint)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  Return query
...
CREATE TABLE IF NOT EXISTS "public"."profile" (
    ...
    "avatar_url" "text" DEFAULT 'https://tapaozmyjsuykgerrfkt.supabase.co/storage/v1/object/public/avatars/avatar.png'::"text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "email" character varying,
...
ALTER TABLE "public"."test_tenant" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."test_tenant_id_seq" OWNER TO "supabase_admin";
...
ALTER TABLE ONLY "public"."lesson_progress"
    ADD CONSTRAINT "lesson_progress_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "public"."groupmember"("id");
...
GRANT ALL ON SEQUENCE "public"."test_tenant_id_seq" TO "postgres";
