...
Below is a video guiding you through the process of creating your inaugural course. Should you have any inquiries, feel free to drop a comment in the YouTube comment section, reach out to us on **[Discord](https://classroomio.com/discord)**, or send a DM on **[Twitter](https://x.com/rotimi_best?s=20)**.
...
A lesson can include more than one deck. On the **Slide** tab, click **Add slide**, pick the platform, and paste the **iframe embed code** from that tool (Google Slides, Canva, PowerPoint, Keynote, Figma, Prezi, Pitch, Gamma, SlideShare, or Beautiful.ai). ClassroomIO sizes every embed consistently — you do not keep the width and height from the snippet.

For per-platform steps, see [Embed slides in a lesson](/create-and-deliver/embed-slides).
