...
1. Open the lesson **Materials** tab and click **Edit**.
2. Select the **Slide** tab and click **Add slide**.
3. Choose your slide platform, paste the embed code from that tool, and confirm.

You can add more than one deck per lesson. See [Add slides and presentations](/build-courses/add-slides-and-presentations) for per-platform steps (Google Slides, Canva, PowerPoint, and more).
