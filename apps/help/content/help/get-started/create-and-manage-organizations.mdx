...
![Organization switcher with the active organization under Your account and other memberships below](./images/create-and-manage-organizations/organization-switcher.webp)
