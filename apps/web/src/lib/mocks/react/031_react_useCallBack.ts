    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'When you need to memoize a function to prevent unnecessary re-renders', is_correct: true },
      ...
      },
      {
        ...
        question_type: QuestionTypes[0], // RADIO
        options: [
          { label: 'An array of dependencies; it specifies when the memoized function should recompute', is_correct: true },
          { label: 'A callback function; it runs after the memoized function is called', is_correct: false },
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'To optimize performance by preventing unnecessary re-renders', is_correct: true },
        ],
      },
      {
