...
// ../../node_modules/.pnpm/carbon-icons-svelte@12.3.0/node_modules/carbon-icons-svelte/lib/LogoYoutube.svelte
var file = "C:/Users/DELL/Desktop/classroomio/classroomio/node_modules/.pnpm/carbon-icons-svelte@12.3.0/node_modules/carbon-icons-svelte/lib/LogoYoutube.svelte";
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("LogoYoutube", slots, []);
  let { size = 16 } = $$props;
...
var LogoYoutube = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get size() {
    throw new Error("<LogoYoutube>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set size(value) {
    throw new Error("<LogoYoutube>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get title() {
    throw new Error("<LogoYoutube>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
var LogoYoutube_default = LogoYoutube;
export {
  LogoYoutube_default as default
};
//# sourceMappingURL=carbon-icons-svelte_lib_LogoYoutube__svelte.js.map
