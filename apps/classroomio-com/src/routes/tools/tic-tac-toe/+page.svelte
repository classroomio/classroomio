...
<section class="mt-[10%] md:mt-16 px-5 py-12 md:px-0 bg-white dark:bg-black">
  <ToolsHeader className="mb-10">
    <img
      ...
      alt="Tic Tac Icon"
    />
    <h1 class="text-4xl md:text-6xl font-bold text-[#040F2D] dark:text-white my-3">Tic-Tac game</h1>
