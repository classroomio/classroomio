---
title: Developers Contribution Guide
description: Guidelines for contributing code to ClassroomIO.
---
...
Did you stumble upon a bug? Encountered a hiccup in deployment? Perhaps you have some user feedback to share? Your quickest route to help us out is by [raising an issue](https://github.com/classroomio/classroomio/issues/new/choose).
...
1. **Fork the Repository:** Fork our repository or use [Gitpod](/developers/contributing/gitpod)
