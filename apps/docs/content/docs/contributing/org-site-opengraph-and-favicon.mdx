...
For admin-facing behavior, see [Share Your Academy (Open Graph & Favicon)](https://classroomio.com/help/publish-your-academy/academy-sharing-and-branding).
...
1. Custom `org.favicon` if set (uploaded under **Settings → Domain**)
...
- [Share Your Academy (Open Graph & Favicon)](https://classroomio.com/help/publish-your-academy/academy-sharing-and-branding) — admin-facing guide
- [Cloudflare Setup](/contributing/cloudflare-setup) — R2 media bucket and `CLOUDFLARE_IMAGE_BUCKET_DOMAIN`
- [Customize Your Organization](https://classroomio.com/help/organization-and-team/customize-organization) — logo, name, theme (user docs)
