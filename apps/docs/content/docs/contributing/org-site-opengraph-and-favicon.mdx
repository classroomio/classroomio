...
For admin-facing behavior, see [Share Your Academy (Open Graph & Favicon)](https://classroomio.com/help/publish-and-brand/academy-sharing-and-branding).
...
1. Custom `org.favicon` if set (uploaded under **Settings → Domains**)
...
- [Share Your Academy (Open Graph & Favicon)](https://classroomio.com/help/publish-and-brand/academy-sharing-and-branding) — admin-facing guide
