...
For full custom domain setup (DNS, verification, which links use your domain), see [Set Up a Custom Domain](/docs/how-to-guides/custom-domain).

For the public homepage (hero, nav, footer), see [Customize Your Academy Landing Page](/docs/how-to-guides/org-landing-page).
...
- [Customize Your Academy Landing Page](/docs/how-to-guides/org-landing-page) — public homepage
- [Set Up a Custom Domain](/docs/how-to-guides/custom-domain) — your own hostname
- [Roles and Permissions](/docs/how-to-guides/roles-and-permissions) — team access
