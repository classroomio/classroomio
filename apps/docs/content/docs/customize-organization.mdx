...
For full custom domain setup (DNS, verification, which links use your domain), see [Set Up a Custom Domain](/custom-domain).

For the public homepage (hero, nav, footer), see [Customize Your Academy Landing Page](/org-landing-page).

For favicon and link-preview behavior when sharing your academy URL, see [Sharing Your Academy (Open Graph & Favicon)](/academy-sharing-and-branding).
...
- [Customize Your Academy Landing Page](/org-landing-page) — public homepage
- [Set Up a Custom Domain](/custom-domain) — your own hostname
- [Sharing Your Academy (Open Graph & Favicon)](/academy-sharing-and-branding) — link previews and browser tab icon
- [Roles and Permissions](/roles-and-permissions) — team access
