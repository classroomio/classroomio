...
![ClassroomIO Organization settings page](/docs/customize-organization.webp)
...
![Custom Domain setup](/docs/domain-setup-one.webp)
...
![Edit Custom domain URL](/docs/domain-setup-two.webp)
...
![Edit Custom domain URL](/docs/domain-setup-three.webp)

</Step>
</Steps>

For full custom domain setup (DNS, verification, which links use your domain), see [Set Up a Custom Domain](/guides/custom-domain).

For the public homepage (hero, nav, footer), see [Customize Your Academy Landing Page](/guides/org-landing-page).

For favicon and link-preview behavior when sharing your academy URL, see [Sharing Your Academy (Open Graph & Favicon)](/guides/academy-sharing-and-branding).
...
- [Customize Your Academy Landing Page](/guides/org-landing-page) — public homepage
- [Set Up a Custom Domain](/guides/custom-domain) — your own hostname
- [Sharing Your Academy (Open Graph & Favicon)](/guides/academy-sharing-and-branding) — link previews and browser tab icon
- [Roles and Permissions](/guides/roles-and-permissions) — team access
