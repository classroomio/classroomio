...
For favicon and link-preview behavior when sharing your academy URL, see [Share Your Academy (Open Graph & Favicon)](/guides/academy-sharing-and-branding).
...
- [Share Your Academy (Open Graph & Favicon)](/guides/academy-sharing-and-branding) — link previews and browser tab icon
