...
- [Course](/course) — lifecycle, settings, and admin areas for a course once it exists
- [Course Types](/guides/course-types) — Self-paced, Live class, Compliance, and Public, and when to use each
- [How Course Enrollment Works](/guides/course-enrollment) — how students get access after you publish
