...
class HotReloader {
    ...
    async getCompilationErrors(page) {
        ...
        } else if ((ref5 = this.clientStats) == null ? void 0 : ref5.hasErrors()) {
            return getErrors(this.clientStats);
        } else if ((ref3 = this.serverStats) == null ? void 0 : ref3.hasErrors()) {
            return getErrors(this.serverStats);
        } else if ((ref4 = this.edgeServerStats) == null ? void 0 : ref4.hasErrors()) {
