...
import StudentCommunity from './student-dashboard-images/student-community.png';
import StudentCommunityQuestion from './student-dashboard-images/student-ask-community-questions.png';
...
The community is a place for you to ask questions you have, and also help people answer questions that you can. To access the community, click on the **Community** option on the left pane of the home page.
<br/>
<Image src={StudentCommunity} alt="student community home page community" quality="100"/>
You can click on any of the questions on the page to provide an answer.

### Asking a Question in the Community
To ask a question in the community, simply click the **Ask Community** button. You will see a page like this:
<br/>
<Image src={StudentCommunityQuestion} alt="asking a question on the community" quality="100"/>

On the page above, simply type a title for your question, and provide more details about it. Once you are done, click the **Publish** button to publish your question.
