...
<Callout type="info">
  ...
  <br />- Use this for **production deployments** (Railway, Docker, or manual). You'll need your
  Project URL, anon key, and service role key. Schema setup is handled during app setup, not in this
  guide.
...
Before starting any of this steps, ensure you have a Supabase account ([sign up here](https://supabase.com))
...
1. **Navigate to Settings**: In your project dashboard, click the gear icon (⚙️) in the left sidebar
...
- Check optional Supabase SMTP settings under Authentication → Email
