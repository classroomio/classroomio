...
import { BasicSurveyQuestion, LinkSurveyQuestion, MultipleSurveyQuestion, RatingSurveyQuestion, Survey, SurveyAppearance, SurveyQuestion } from '../../posthog-surveys-types';
...
export declare function showQuestion(n: number, surveyId: string): void;
export declare function nextQuestion(currentQuestionIdx: number, surveyId: string): void;
