...
// ../../node_modules/.pnpm/carbon-icons-svelte@12.1.0/node_modules/carbon-icons-svelte/lib/CopyFile.svelte
var file = "C:/Users/DELL/Desktop/classroomio/classroomio/node_modules/.pnpm/carbon-icons-svelte@12.1.0/node_modules/carbon-icons-svelte/lib/CopyFile.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path1, file, 23, 212, 783);
...
var CopyFile = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get size() {
    throw new Error("<CopyFile>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set size(value) {
    throw new Error("<CopyFile>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get title() {
    throw new Error("<CopyFile>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
var CopyFile_default = CopyFile;

export {
  CopyFile_default
};
//# sourceMappingURL=chunk-EC36NX3K.js.map
