<script lang="ts">
  ...
  const courses = $derived(programApi.courses);
...
<AddCourseToProgramModal bind:open={showAddCourseModal} programId={data.programId} />
<DeleteModal bind:open={showDeleteModal} onDelete={handleRemoveCourse} isLoading={programApi.isLoading} />
