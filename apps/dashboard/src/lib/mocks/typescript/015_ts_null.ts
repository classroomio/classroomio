    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            label:
              'null represents an intentional absence of any object value, while undefined represents a variable that has been declared but not assigned.',
            is_correct: true
          },
          {
      ...
      },
      {
        ...
        options: [
          {
            label: 'It performs bitwise operations on null and undefined values',
            is_correct: false
          },
          {
            label: 'It throws an error when used with null or undefined values',
            is_correct: false
          },
          {
            label:
      ...
      },
      {
        ...
        options: [
          ...
          {
            label: 'No, "undefined" is a reserved keyword and cannot be used as a variable name',
            is_correct: false
          }
        ]
      }
