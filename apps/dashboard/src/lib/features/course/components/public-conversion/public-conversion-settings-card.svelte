<script lang="ts">
  ...
  let { course, offenders, onCancel, disabled = false }: Props = $props();
...
<div class="ui:border-destructive/40 w-full space-y-4 rounded-lg border p-4" role="alert">
  ...
  {#if onCancel}
    <div class="ui:border-destructive/20 flex justify-end border-t pt-1">
      <Button
        variant="ghost"
        size="sm"
