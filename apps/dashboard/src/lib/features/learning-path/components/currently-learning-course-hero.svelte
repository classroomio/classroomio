...
<div
  class="ui:from-secondary ui:to-background flex flex-col gap-5 rounded-2xl border bg-gradient-to-br p-5 sm:flex-row md:gap-6"
>
  <a
    {href}
    class="group relative flex aspect-[30/8] w-full shrink-0 items-center justify-center overflow-hidden rounded-xl focus-visible:outline-none sm:aspect-auto sm:w-56 md:w-64"
