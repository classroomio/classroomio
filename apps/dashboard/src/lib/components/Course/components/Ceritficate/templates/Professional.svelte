...
<div
  class="certificate-bg border-primary-400 flex w-full items-center justify-center border border-dashed"
>
  <div class="{borderwidth} {bordercolor} w-full">
    <div class="w-full px-5 py-3">
      ...
      <div class="mb-2">
        ...
        <div>
          <p
            class="clamp text-primary-800 my-2 bg-transparent text-center text-base font-semibold uppercase"
          >
            {$course.title}
          </p>
        </div>
