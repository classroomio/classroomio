<script lang="ts">
  ...
  import ShineBorder from '$lib/components/AnimationComponents/ShineBorder.svelte';
...
<ShineBorder class="" color="white">
  <a
    ...
    bind:this={target}
    href={getCourseUrl()}
    class="text-black border dark:border-none border-gray dark:border-neutral-600 rounded w-full max-w-[320px] relative"
  >
    <div class="p-4">
