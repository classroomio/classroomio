...
<nav class={`relative w-full flex items-center justify-between py-4 px-6 ${backgroundColor}`}>
  ...
  >
    ...
    {#if $user.isLoggedIn}
      <li class="py-4 px-6 border-b">About me</li>
      <li class="py-4 px-6 border-b">Courses</li>
      <li class="py-4 px-6 border-b">Learning path</li>
      <li class="py-4 px-6 border-b">Testimonials</li>
      {#if isOrgSite}
