<script lang="ts">
  ...
  //   let isPathwayComplete = false; CHANGE BACK TO FALSE
...
<Box>
  <div class="flex flex-col items-center border border-black justify-center w-max h-full gap-5">
    ...
    <p class="text-black">YOU ARE ALLOWED</p>
  </div>
</Box>
