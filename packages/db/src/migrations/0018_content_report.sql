...
--> statement-breakpoint
CREATE UNIQUE INDEX "content_report_reporter_target_open_unique" ON "content_report" USING btree ("organization_id","reporter_id","target_type","target_id") WHERE "content_report"."reporter_id" IS NOT NULL AND "content_report"."status" IN ('open', 'in_review');
