...
export type TOrgNoteFavorite = typeof schema.orgNoteFavorite.$inferSelect;
export type TNewOrgNoteFavorite = typeof schema.orgNoteFavorite.$inferInsert;
export type TOrgNoteShare = typeof schema.orgNoteShare.$inferSelect;
export type TNewOrgNoteShare = typeof schema.orgNoteShare.$inferInsert;
export type TNoteSharePermission = (typeof schema.noteSharePermission.enumValues)[number];
