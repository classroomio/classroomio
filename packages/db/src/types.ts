...
export type TDocTagAssignment = typeof schema.docTagAssignment.$inferSelect;
export type TNewDocTagAssignment = typeof schema.docTagAssignment.$inferInsert;
...
export type TOrgNote = typeof schema.orgDoc.$inferSelect;
export type TNewOrgNote = typeof schema.orgDoc.$inferInsert;
export type TOrgNoteVersion = typeof schema.orgDocVersion.$inferSelect;
export type TNewOrgNoteVersion = typeof schema.orgDocVersion.$inferInsert;
export type TOrgNoteCommentThread = typeof schema.orgDocCommentThread.$inferSelect;
export type TNewOrgNoteCommentThread = typeof schema.orgDocCommentThread.$inferInsert;
export type TOrgNoteComment = typeof schema.orgDocComment.$inferSelect;
export type TNewOrgNoteComment = typeof schema.orgDocComment.$inferInsert;
export type TOrgNoteCommentMention = typeof schema.orgDocCommentMention.$inferSelect;
export type TNewOrgNoteCommentMention = typeof schema.orgDocCommentMention.$inferInsert;
export type TOrgNoteFavorite = typeof schema.orgDocFavorite.$inferSelect;
export type TNewOrgNoteFavorite = typeof schema.orgDocFavorite.$inferInsert;
export type TOrgNoteShare = typeof schema.orgDocShare.$inferSelect;
export type TNewOrgNoteShare = typeof schema.orgDocShare.$inferInsert;
export type TDocSharePermission = (typeof schema.docSharePermission.enumValues)[number];
export type TDocOrigin = (typeof schema.docOrigin.enumValues)[number];
