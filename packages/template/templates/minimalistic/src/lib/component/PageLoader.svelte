...
<section class="w-screen h-screen p-5">
  ...
  <div class="flex items-center justify-between w-full rounded-md overflow-hidden">
    <Skeleton style="width:80%; margin-right:10rem;border-radius:10px" />
    <div class="flex items-center justify-between w-[20%]">
      <Skeleton style="width:2%;  margin-right:1rem; border-radius:10px" />
      <Skeleton style="width:2%;  margin-right:1rem; border-radius:10px" />
      <Skeleton style="width:2%;  border-radius:10px" />
    </div>
  </div>
  <!-- hero -->
  <div
