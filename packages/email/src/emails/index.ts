...
export * from './student-learning-path-welcome';
...
import type { studentLearningPathWelcomeEmail } from './student-learning-path-welcome';
...
export type EmailSchemas = {
  ...
  studentLearningPathWelcome: typeof studentLearningPathWelcomeEmail.template.schema;
