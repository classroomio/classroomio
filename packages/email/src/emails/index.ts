...
export * from './content-report-alert';
...
import type { contentReportAlertEmail } from './content-report-alert';
...
export type EmailSchemas = {
  ...
  contentReportAlert: typeof contentReportAlertEmail.template.schema;
};
