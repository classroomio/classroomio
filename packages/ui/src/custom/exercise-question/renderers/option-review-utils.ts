...
export function getMcqReviewRowBorderClass(isSelected: boolean, isCorrect: boolean): string {
  if (isSelected && isCorrect) {
    return 'ui:border-emerald-500 ui:bg-emerald-50/40 ui:dark:bg-emerald-950/30';
  }
  if (isSelected && !isCorrect) {
    return 'ui:border-red-500 ui:bg-red-50/40 ui:dark:bg-red-950/30';
  }
  if (!isSelected && isCorrect) {
    return 'ui:border-emerald-300 ui:bg-emerald-50/20 ui:dark:bg-emerald-950/20';
  }
