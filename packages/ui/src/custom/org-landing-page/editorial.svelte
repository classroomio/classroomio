<script lang="ts">
  ...
  import EditorialNav from './editorial/nav.svelte';
  import EditorialHero from './editorial/hero.svelte';
  import EditorialCourseCard from './editorial/course-card.svelte';
