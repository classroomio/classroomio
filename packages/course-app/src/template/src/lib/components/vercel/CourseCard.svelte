...
>
  ...
  <div class="relative flex max-h-[500px] min-h-[400px] w-full flex-col justify-end p-2">
    <div class="flex flex-1 flex-col items-start justify-end py-4">
      <p class="z-10 line-clamp-1 overflow-ellipsis font-semibold text-white">
        {title}
      </p>
      <p class="z-10 mb-4 line-clamp-3 overflow-ellipsis text-sm text-white">
        {description}
      </p>
    ...
    >
      ...
      <span class="bg-vercel flex items-center justify-center rounded-full p-2">
