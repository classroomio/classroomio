...
{#if content?.show}
  <nav
    class="flex w-full flex-col items-start gap-4 bg-black px-6 py-4 text-white md:flex-row md:items-center md:justify-between md:px-20"
  >
    <ul
      class="flex flex-col items-start gap-4 font-semibold capitalize md:flex-row md:items-center md:gap-8"
    >
