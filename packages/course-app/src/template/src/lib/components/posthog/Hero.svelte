      ...
      >
        <div class="space-y-6 w-full mb-4">
          ...
          <Button
            ...
            class="capitalize py-2 px-3 bg-posthog-primary text-black ring-1 ring-[#B17816] dark:bg-[#EB9D2A] hover:scale-95 hover:bg-[#EB9D2A] shadow-[0px_3px_#B17816] font-bold mb-4"
