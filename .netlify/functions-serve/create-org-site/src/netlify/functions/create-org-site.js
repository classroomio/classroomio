...
// node_modules/netlify/node_modules/node-fetch/src/errors/base.js
var FetchBaseError;
var init_base = __esm({
  "node_modules/netlify/node_modules/node-fetch/src/errors/base.js"() {
...
// node_modules/netlify/node_modules/node-fetch/src/errors/fetch-error.js
var FetchError;
...
// node_modules/netlify/node_modules/node-fetch/src/utils/is.js
...
// node_modules/netlify/node_modules/node-fetch/src/utils/multipart-parser.js
...
// node_modules/netlify/node_modules/node-fetch/src/body.js
...
// node_modules/netlify/node_modules/node-fetch/src/headers.js
...
// node_modules/netlify/node_modules/node-fetch/src/utils/is-redirect.js
...
// node_modules/netlify/node_modules/node-fetch/src/response.js
...
// node_modules/netlify/node_modules/node-fetch/src/utils/get-search.js
var getSearch;
...
// node_modules/netlify/node_modules/node-fetch/src/utils/referrer.js
...
// node_modules/netlify/node_modules/node-fetch/src/request.js
...
// node_modules/netlify/node_modules/node-fetch/src/errors/abort-error.js
var AbortError2;
...
// node_modules/netlify/node_modules/node-fetch/src/index.js
...
// node_modules/omit.js/lib/index.js
var require_lib = __commonJS({
  "node_modules/omit.js/lib/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.default = void 0;
    function omit3(obj, fields) {
...
// node_modules/netlify/lib/open_api.js
var import_module, import_meta, require2, openApiSpec;
var init_open_api = __esm({
  "node_modules/netlify/lib/open_api.js"() {
    import_module = require("module");
    import_meta = {};
    require2 = (0, import_module.createRequire)(import_meta.url);
    openApiSpec = require2("@netlify/open-api");
  }
});

// node_modules/netlify/lib/operations.js
var import_omit, getOperations, getParameters, addParameter;
var init_operations = __esm({
  "node_modules/netlify/lib/operations.js"() {
    import_omit = __toESM(require_lib(), 1);
    init_open_api();
    getOperations = function() {
      return Object.entries(openApiSpec.paths).flatMap(([path, pathItem]) => {
        const operations = import_omit.default.default(pathItem, ["parameters"]);
        return Object.entries(operations).map(([method, operation]) => {
          ...
          return __spreadProps(__spreadValues({}, operation), { verb: method, path, parameters });
        });
      });
    };
    getParameters = function(pathParameters = [], operationParameters = []) {
      const parameters = [...pathParameters, ...operationParameters];
      return parameters.reduce(addParameter, { path: {}, query: {}, body: {} });
    };
    addParameter = function(parameters, param) {
      return __spreadProps(__spreadValues({}, parameters), { [param.in]: __spreadProps(__spreadValues({}, parameters[param.in]), { [param.name]: param }) });
    };
  }
});

// node_modules/netlify/lib/methods/body.js
var addBody, isBinaryBody, isBodyParam;
var init_body2 = __esm({
  "node_modules/netlify/lib/methods/body.js"() {
    addBody = function(body, parameters, opts) {
      if (!body) {
        return opts;
      }
      ...
      if (isBinaryBody(parameters)) {
        return __spreadProps(__spreadValues({}, opts), {
          body: bodyA,
          headers: __spreadValues({ "Content-Type": "application/octet-stream" }, opts.headers)
        });
      }
      return __spreadProps(__spreadValues({}, opts), {
    ...
    isBinaryBody = function(parameters) {
      return Object.values(parameters.body).some(isBodyParam);
    };
    isBodyParam = function({ schema }) {
...
// node_modules/netlify/lib/methods/params.js
var getRequestParams, getRequestParam;
var init_params = __esm({
  "node_modules/netlify/lib/methods/params.js"() {
    init_lodash();
    getRequestParams = function(params, requestParams, name) {
      const entries = Object.values(params).map((param) => getRequestParam(param, requestParams, name));
      return Object.assign({}, ...entries);
    };
    getRequestParam = function(param, requestParams, name) {
      const value = requestParams[param.name] || requestParams[camelCase_default(param.name)];
      if (value !== void 0) {
...
var require_pagination = __commonJS({
  "node_modules/micro-api-client/lib/pagination.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    exports2.getPagination = getPagination;
...
var require_lib2 = __commonJS({
  "node_modules/micro-api-client/lib/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.JSONHTTPError = exports2.TextHTTPError = exports2.HTTPError = exports2.getPagination = void 0;
    ...
    Object.defineProperty(exports2, "getPagination", {
      enumerable: true,
      get: function get() {
    ...
    var HTTPError = exports2.HTTPError = function(_extendableBuiltin2) {
    ...
    var TextHTTPError2 = exports2.TextHTTPError = function(_HTTPError) {
      _inherits(TextHTTPError3, _HTTPError);
      function TextHTTPError3(response, data) {
        _classCallCheck(this, TextHTTPError3);
        var _this2 = _possibleConstructorReturn(this, (TextHTTPError3.__proto__ || Object.getPrototypeOf(TextHTTPError3)).call(this, response));
        _this2.data = data;
        return _this2;
      }
      return TextHTTPError3;
    }(HTTPError);
    var JSONHTTPError2 = exports2.JSONHTTPError = function(_HTTPError2) {
      _inherits(JSONHTTPError3, _HTTPError2);
      function JSONHTTPError3(response, json) {
        _classCallCheck(this, JSONHTTPError3);
        var _this3 = _possibleConstructorReturn(this, (JSONHTTPError3.__proto__ || Object.getPrototypeOf(JSONHTTPError3)).call(this, response));
        _this3.json = json;
        return _this3;
      }
      return JSONHTTPError3;
    }(HTTPError);
    var API = function() {
      function API2() {
      ...
      _createClass(API2, [{
        ...
        value: function parseJsonResponse2(response) {
          return response.json().then(function(json) {
            if (!response.ok) {
              return Promise.reject(new JSONHTTPError2(response, json));
            }
          ...
          return fetch(this.apiURL + path, _extends({}, options, { headers })).then(function(response) {
            ...
            if (!response.ok) {
              return response.text().then(function(data) {
                return Promise.reject(new TextHTTPError2(response, data));
              });
            }
            return response.text().then(function(data) {
              data;
...
// node_modules/netlify/lib/methods/response.js
var import_micro_api_client, import_omit2, parseResponse, getResponseType, parseJsonResponse, addFallbackErrorMessage, getFetchError;
var init_response2 = __esm({
  "node_modules/netlify/lib/methods/response.js"() {
    import_micro_api_client = __toESM(require_lib2(), 1);
    import_omit2 = __toESM(require_lib(), 1);
    parseResponse = async function(response) {
      ...
      if (!response.ok) {
        const ErrorType = responseType === "json" ? import_micro_api_client.JSONHTTPError : import_micro_api_client.TextHTTPError;
        throw addFallbackErrorMessage(new ErrorType(response, parsedResponse), textResponse);
      }
      return parsedResponse;
    };
    getResponseType = function({ headers }) {
    ...
    parseJsonResponse = function(response, textResponse, responseType) {
      ...
      try {
        ...
        throw addFallbackErrorMessage(new import_micro_api_client.TextHTTPError(response, textResponse), textResponse);
      }
    };
    addFallbackErrorMessage = function(error, textResponse) {
      error.message = error.message || textResponse;
      return error;
    };
    getFetchError = function(error, url, opts) {
      const data = import_omit2.default.default(opts, ["Authorization"]);
...
// node_modules/netlify/lib/methods/retry.js
var shouldRetry, waitForRetry, getDelay, sleep, DEFAULT_RETRY_DELAY, MIN_RETRY_DELAY, SECS_TO_MSECS, MAX_RETRY, RATE_LIMIT_STATUS, RATE_LIMIT_HEADER, RETRY_ERROR_CODES;
var init_retry = __esm({
  "node_modules/netlify/lib/methods/retry.js"() {
    shouldRetry = function({ response = {}, error = {}, method = {} }) {
    ...
    waitForRetry = async function(response) {
      const delay = getDelay(response);
      await sleep(delay);
    };
    getDelay = function(response) {
      if (response === void 0) {
    ...
    DEFAULT_RETRY_DELAY = 5e3;
    MIN_RETRY_DELAY = 1e3;
    SECS_TO_MSECS = 1e3;
    MAX_RETRY = 5;
    RATE_LIMIT_STATUS = 429;
    RATE_LIMIT_HEADER = "X-RateLimit-Reset";
    RETRY_ERROR_CODES = /* @__PURE__ */ new Set(["ETIMEDOUT", "ECONNRESET"]);
  }
});
...
// node_modules/netlify/node_modules/qs/lib/formats.js
var require_formats = __commonJS({
  "node_modules/netlify/node_modules/qs/lib/formats.js"(exports2, module2) {
    "use strict";
    var replace = String.prototype.replace;
...
// node_modules/netlify/node_modules/qs/lib/utils.js
var require_utils = __commonJS({
  "node_modules/netlify/node_modules/qs/lib/utils.js"(exports2, module2) {
    "use strict";
...
// node_modules/netlify/node_modules/qs/lib/stringify.js
var require_stringify = __commonJS({
  "node_modules/netlify/node_modules/qs/lib/stringify.js"(exports2, module2) {
    "use strict";
...
// node_modules/netlify/node_modules/qs/lib/parse.js
var require_parse = __commonJS({
  "node_modules/netlify/node_modules/qs/lib/parse.js"(exports2, module2) {
    "use strict";
    var utils = require_utils();
    var has = Object.prototype.hasOwnProperty;
    var isArray2 = Array.isArray;
...
// node_modules/netlify/node_modules/qs/lib/index.js
var require_lib3 = __commonJS({
  "node_modules/netlify/node_modules/qs/lib/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/netlify/lib/methods/url.js
var import_qs, getUrl, addPathParams, addPathParam, addQueryParams;
var init_url = __esm({
  "node_modules/netlify/lib/methods/url.js"() {
    import_qs = __toESM(require_lib3(), 1);
    init_params();
    getUrl = function({ path, parameters }, basePath, requestParams) {
      const url = `${basePath}${path}`;
      const urlA = addPathParams(url, parameters, requestParams);
      const urlB = addQueryParams(urlA, parameters, requestParams);
      return urlB;
    };
    addPathParams = function(url, parameters, requestParams) {
    ...
    addPathParam = function(url, [name, value]) {
      return url.replace(`{${name}}`, value);
    };
    addQueryParams = function(url, parameters, requestParams) {
      const queryParams = getRequestParams(parameters.query, requestParams, "query variable");
      if (Object.keys(queryParams).length === 0) {
        return url;
      }
      return `${url}?${import_qs.default.stringify(queryParams, { arrayFormat: "brackets" })}`;
    };
  }
});

// node_modules/netlify/lib/methods/index.js
var getMethods, getMethod, callMethod, getOpts, addHeaderParams, addHttpMethod, addDefaultHeaders, addAgent, makeRequestOrRetry, makeRequest;
var init_methods = __esm({
  "node_modules/netlify/lib/methods/index.js"() {
    ...
    init_retry();
    init_url();
    getMethods = function({ basePath, defaultHeaders, agent, globalParams }) {
      const operations = getOperations();
      const methods2 = operations.map((method) => getMethod({ method, basePath, defaultHeaders, agent, globalParams }));
      return Object.assign({}, ...methods2);
    };
    getMethod = function({ method, basePath, defaultHeaders, agent, globalParams }) {
      return {
    ...
    callMethod = async function({ method, basePath, defaultHeaders, agent, globalParams, params, opts }) {
      const requestParams = __spreadValues(__spreadValues({}, globalParams), params);
    ...
    getOpts = function({ method: { verb, parameters }, defaultHeaders, agent, requestParams, opts }) {
    ...
    addHeaderParams = function(parameters, requestParams, opts) {
      if (parameters.header === void 0) {
        return opts;
      }
      return __spreadProps(__spreadValues({}, opts), { headers: getRequestParams(parameters.header, requestParams, "header parameter") });
    };
    addHttpMethod = function(verb, opts) {
      return __spreadProps(__spreadValues({}, opts), { method: verb.toUpperCase() });
    };
    addDefaultHeaders = function(defaultHeaders, opts) {
      return __spreadProps(__spreadValues({}, opts), { headers: __spreadValues(__spreadValues({}, defaultHeaders), opts.headers) });
    };
    addAgent = function(agent, opts) {
      if (agent) {
        return __spreadProps(__spreadValues({}, opts), { agent });
      }
      return opts;
    };
    makeRequestOrRetry = async function({ url, method, defaultHeaders, agent, requestParams, opts }) {
    ...
    makeRequest = async function(url, opts) {
      try {
...
// node_modules/netlify/lib/index.js
var lib_exports = {};
__export(lib_exports, {
  NetlifyAPI: () => NetlifyAPI,
  methods: () => methods
});
var NetlifyAPI, getBasePath, DEFAULT_TICKET_POLL, DEFAULT_TICKET_TIMEOUT, methods;
var init_lib = __esm({
  "node_modules/netlify/lib/index.js"() {
    init_p_wait_for();
    init_methods();
    ...
    NetlifyAPI = class {
      constructor(firstArg, secondArg) {
        ...
        const methods2 = getMethods({ basePath, defaultHeaders, agent, globalParams });
        Object.assign(this, __spreadProps(__spreadValues({}, methods2), { defaultHeaders, scheme, host, pathPrefix, globalParams, accessToken, agent }));
      }
      get accessToken() {
      ...
      async getAccessToken(ticket, { poll = DEFAULT_TICKET_POLL, timeout = DEFAULT_TICKET_TIMEOUT } = {}) {
        ...
        const checkTicket = async () => {
          const t2 = await this.showTicket({ ticketId: id });
          if (t2.authorized) {
            authorizedTicket = t2;
          }
          return Boolean(t2.authorized);
        };
    ...
    getBasePath = function({ scheme, host, pathPrefix }) {
      return `${scheme}://${host}${pathPrefix}`;
    };
    DEFAULT_TICKET_POLL = 1e3;
    DEFAULT_TICKET_TIMEOUT = 36e5;
    methods = getOperations();
  }
});

// netlify/functions/create-org-site.js
var { NetlifyAPI: NetlifyAPI2 } = (init_lib(), __toCommonJS(lib_exports));
exports.handler = async function(event) {
  console.log("process.env.SVELTE_APP_NETLIFY_API_KEY", process.env.SVELTE_APP_NETLIFY_API_KEY);
  const client = new NetlifyAPI2(process.env.SVELTE_APP_NETLIFY_API_KEY);
 ...
 */
//# sourceMappingURL=create-org-site.js.map
