...
- Video ingestion, YouTube transcript ingestion, or podcast/audio ingestion (lesson YouTube captions are a separate PRD: [`prd/youtube-embed-transcripts [DONE]`](../youtube-embed-transcripts%20[DONE]/README.md))
...
- YouTube/video transcript ingestion (see [`prd/youtube-embed-transcripts [DONE]`](../youtube-embed-transcripts%20[DONE]/README.md) for lesson YouTube captions; this PRD still excludes video as a Study from Source input)
