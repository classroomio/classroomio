...
| YouTube transcript ingestion | Missing | Existing agent tools explicitly say embedded YouTube links return no transcript. Lesson-scoped fetch + cache is specified in [`prd/youtube-embed-transcripts [DONE]`](../youtube-embed-transcripts%20[DONE]/README.md); research runs should reuse that caption cache instead of a second transcript table. |
...
- [YouTube Embed Transcripts PRD](../youtube-embed-transcripts%20[DONE]/README.md) — shared caption cache for lesson AI and this research workflow
