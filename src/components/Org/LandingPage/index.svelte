<script>
  ...
  import LogoFacebook from 'carbon-icons-svelte/lib/LogoFacebook24';
  import LogoTwitter from 'carbon-icons-svelte/lib/LogoTwitter24';
  import LogoLinkedin from 'carbon-icons-svelte/lib/LogoLinkedin24';

  import Navigation from '../../Navigation/index.svelte';
  import Box from '../../Box/index.svelte';
  import Card from '../../Courses/components/Card/index.svelte';
  import CardLoader from '../../Courses/components/Card/Loader.svelte';
