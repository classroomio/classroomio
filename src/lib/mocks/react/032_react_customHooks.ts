    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Yes, custom hooks can have their own state using the "useState" hook', is_correct: true },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          { label: 'When you have logic that is reused across multiple components', is_correct: true },
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Yes, custom hooks can accept parameters like any regular function', is_correct: true },
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'An array with values and functions as needed by the component', is_correct: true },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Importing and using the custom hook in the components that need it', is_correct: true },
