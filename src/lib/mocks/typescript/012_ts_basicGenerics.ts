    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'To create reusable functions and classes that work with different types', is_correct: true },
      ...
      },
      {
        ...
        question_type: QuestionTypes[1], // CHECKBOX
        options: [
          { label: 'To specify a type that the generic type parameter must extend', is_correct: true },
          { label: 'To specify a type that the generic type parameter must be equal to', is_correct: false },
          { label: 'To specify a type that the generic type parameter must not extend', is_correct: false },
        ],
      },
      {
