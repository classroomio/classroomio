    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: 'Providing a new implementation for a parent class method in a child class', is_correct: true },
        ],
      },
      {
        ...
        question_type: QuestionTypes[0], // RADIO
        options: [
          { label: 'It is a reserved keyword and cannot be used as a parameter', is_correct: false },
          { label: 'It refers to the instance of the class and is used to access its attributes and methods', is_correct: true },
